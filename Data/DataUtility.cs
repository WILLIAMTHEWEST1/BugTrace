    ...
    public static class DataUtility
    {
        ...
        private static async Task SeedCompaniesAsync(ApplicationDbContext context)
        {
            try
            {
                ...
                company1Id = context.Companies.FirstOrDefault(c => c.Name == "Company 1").Id;
                company2Id = context.Companies.FirstOrDefault(c => c.Name == "Company 2").Id;
                company3Id = context.Companies.FirstOrDefault(c => c.Name == "Company 3").Id;
                company4Id = context.Companies.FirstOrDefault(c => c.Name == "Company 4").Id;
                company5Id = context.Companies.FirstOrDefault(c => c.Name == "Company 5").Id;
        ...
        private static async Task SeedUsersAsync(UserManager<BTUser> userManager)
        {
        ...
        public static async Task SeedProjectPrioritiesAsync(ApplicationDbContext context)
        {
            try
            {
        ...
        public static async Task SeedTicketStatusAsync(ApplicationDbContext context)
        {
            try
            {
        ...
        public static async Task SeedTicketPrioritiesAsync(ApplicationDbContext context)
        {
            try
            {
        ...
        public static async Task SeedTicketTypesAsync(ApplicationDbContext context)
        {
            try
            {
        ...
        static async Task SeedProjectsAsync(ApplicationDbContext context)
        {
        ...
        static async Task SeedTicketsAsync(ApplicationDbContext context)
        {
            //Get project Ids
