...
namespace BugTrace.Data.Migrations
{
    ...
    [Migration("20211118215618_BT-Models-2")]
    partial class BTModels2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BugTrace.Models.Invite", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("BugTrace.Models.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("BugTrace.Models.NotificationType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("BugTrace.Models.TicketAttachment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("BugTrace.Models.TicketComment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("BugTrace.Models.TicketHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("BugTrace.Models.TicketPriority", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("BugTrace.Models.TicketStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("BugTrace.Models.TicketType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("BugTrace.Models.Invite", b =>
                {
                    ...
                    b.HasOne("BugTrace.Models.BTUser", "Invitee")
                        .WithMany()
                        .HasForeignKey("InviteeId");

                    b.HasOne("BugTrace.Models.BTUser", "Invitor")
                        .WithMany()
            ...
            modelBuilder.Entity("BugTrace.Models.Notification", b =>
                {
                    b.HasOne("BugTrace.Models.NotificationType", "NotificationType")
                        .WithMany()
                    ...
                    b.HasOne("BugTrace.Models.BTUser", "Recipient")
                        .WithMany()
                        .HasForeignKey("RecipientId");

                    b.HasOne("BugTrace.Models.BTUser", "Sender")
                        .WithMany()
            ...
            modelBuilder.Entity("BugTrace.Models.Ticket", b =>
                {
                    b.HasOne("BugTrace.Models.BTUser", "DeveloperUser")
                        .WithMany()
                        .HasForeignKey("DeveloperUserId");

                    b.HasOne("BugTrace.Models.BTUser", "OwnerUser")
                        .WithMany()
                    ...
                    b.HasOne("BugTrace.Models.TicketPriority", "TicketPriority")
                        .WithMany()
            ...
            modelBuilder.Entity("BugTrace.Models.TicketAttachment", b =>
                {
                    ...
                    b.HasOne("BugTrace.Models.TicketTask", null)
                        .WithMany("TaskAttachments")
                        .HasForeignKey("TicketTaskId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BugTrace.Models.BTUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("BugTrace.Models.TicketTask", b =>
                {
                    b.HasOne("BugTrace.Models.TicketStatus", "TaskStatus")
                        .WithMany()
                        .HasForeignKey("TaskStatusId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BugTrace.Models.TicketType", "TaskType")
                        .WithMany()
