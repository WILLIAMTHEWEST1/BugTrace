...
namespace BugTrace.Controllers
{
    ...
    
    {
        ...
        {
            ViewData["CompanyId"] = new SelectList(_context.Companies, "Id", "CompanyId");
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CompanyId,Name,Description,ProjectPriorityId,CreatedDate,StartDate,EndDate,ImageFileName,ImageFileData,ImageContentType,Archived")] Project project)
        {
            if (id != project.Id)
            {
                return NotFound();
