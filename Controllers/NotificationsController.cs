...
namespace BugTrace.Controllers
{
    public class NotificationsController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Notifications.Include(n => n.NotificationType).Include(n => n.Project).Include(n => n.Sender).Include(n => n.Ticket);
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,NotificationTypeId,Message,CreatedDate,Viewed,TicketId,ProjectId,RecipeintId,SenderId")] Notification notification)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,NotificationTypeId,Message,CreatedDate,Viewed,TicketId,ProjectId,RecipeintId,SenderId")] Notification notification)
        {
